...
let apiUrl = 'https://api.weatherapi.com/v1/current.json?key=ed1ea82dec784e47b9d165458231506&aqi=no&q='
...
let showError = () => {
    apiDataContainer.innerHTML = `<div class="weather__error">City not found....API problem</div>`
}
